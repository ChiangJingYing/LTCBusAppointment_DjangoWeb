...
class Announcement(models.Model):
    ...
    tittle = models.CharField(db_column='Tittle', max_length=50, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    content = models.CharField(db_column='Content', max_length=200, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    publisher = models.ForeignKey('Managers', models.DO_NOTHING, db_column='Publisher')  # Field name made lowercase.
    publish_time = models.DateTimeField(db_column='Publish_Time')  # Field name made lowercase.
...
class Appointment(models.Model):
    ...
    status = models.CharField(db_column='Status', max_length=20, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
...
class Qa(models.Model):
    ...
    manager = models.ForeignKey(Managers, models.DO_NOTHING, db_column='Manager_ID')  # Field name made lowercase.
    question = models.CharField(db_column='Question', max_length=100, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    answer = models.CharField(db_column='Answer', max_length=100, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    type = models.CharField(db_column='Type', max_length=20, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
...
class RealLocation(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    location = models.CharField(db_column='Location', max_length=100, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    time = models.DateTimeField(db_column='Time')  # Field name made lowercase.
    vehicle = models.ForeignKey('Vehicle', models.DO_NOTHING, db_column='Vehicle')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'Real_Location'
...
class Refueling(models.Model):
    ...
    type = models.CharField(db_column='Type', max_length=20, db_collation='utf8mb3_general_ci')  # Field name made lowercase.
    pay_money = models.DecimalField(db_column='Pay_Money', max_digits=10, decimal_places=0)  # Field name made lowercase.
    refueling = models.DecimalField(db_column='Refueling', max_digits=10, decimal_places=0)  # Field name made lowercase.
