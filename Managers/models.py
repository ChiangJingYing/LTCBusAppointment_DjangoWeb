...
class Auxiliarytool(models.Model):
    ...
    tool_name = models.CharField(
        db_column='Tool_Name', max_length=50,
        db_collation='utf8mb3_general_ci'
    )  # Field name made lowercase.
    min_size = models.CharField(
        db_column='Min_Size', max_length=20,
        db_collation='utf8mb3_general_ci'
    )  # Field name made lowercase.
...
class User(models.Model):
    ...
    contact_person_phone = models.CharField(
        db_column='Contact_Person_Phone',
        max_length=20,
        db_collation='utf8mb3_general_ci',
        verbose_name='聯絡人電話'
    )  # Field name made lowercase.
    contact_relationship = models.CharField(
        db_column='Contact_Relationship',
        max_length=20,
        db_collation='utf8mb3_general_ci',
        verbose_name='聯絡人關係'
    )  # Field name made lowercase.
